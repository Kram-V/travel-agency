  ...
  <div class="main-content">
      <section class="section">
          <div class="section-header justify-content-between">
              <h1>Team Members</h1>
              <div class="ml-auto">
                <a href="{{ route('admin_team_members_create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Add New</a>
            </div>
          </div>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td class="pt_10 pb_10">
                                              <a href="{{ route('admin_team_members_edit', $team_member->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
