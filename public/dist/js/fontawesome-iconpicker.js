                    ...
                    f = function (a) {
                        var e = p.left - z.left,
                            ...
                            l = {
                                ...
                                horizontal:
                                    f < 0 ? "left" : e > 0 ? "right" : "center",
                                vertical:
                                    k < 0 ? "top" : i > 0 ? "bottom" : "middle",
                            };
                        if (n < h && d(e + f) < n) {
                            l.horizontal = "center";
                        }
            ...
            flip: {
                left: function (b, c) {
                    ...
                    if (j < 0) {
                        ...
                        p =
                            b.left -
                            c.collisionPosition.marginLeft +
                            l +
                            m +
                            n -
                            h;
            ...
            for (var d in this.options.icons) {
                if (typeof this.options.icons[d].title === "string") {
                    ...
                    this.iconpicker
                        ...
                        .append(
                            e.attr("title", "." + this.options.icons[d].title)
                        );
            ...
            if (this.hasInput()) {
                this.input.on("keyup.iconpicker", function (d) {
                    if (
                        ...
                        c._updateFormGroupStatus(
                            c.getValid(this.value) !== false
                        );
                    }
